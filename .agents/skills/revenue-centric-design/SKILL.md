...
This project carries a lean installation without the optional diagrams and screenshots. Their
descriptions remain in the reference files, alongside the principles and source links.
